  ...
  return (
    <div id="histoire" className="fixed inset-0 z-50 bg-[var(--bg)] overflow-y-auto animate-fadeIn">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 xl:px-16 py-20 md:py-28 lg:py-32">
        ...
        <h1 className="font-sans text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-[-0.03em] mb-4 sm:mb-5">{t('histoire.title')}</h1>
        <p className="text-[12px] sm:text-[13px] lg:text-sm text-[var(--muted)] mb-14 sm:mb-16 lg:mb-18 leading-relaxed">{t('histoire.subtitle')}</p>
